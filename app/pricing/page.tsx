...
import { Check, Sparkles, Award, ArrowRight, ShieldCheck, Zap } from 'lucide-react';
import { CERT_TIERS, CORE_TIER_ORDER, ROLE_TIER_ORDER } from '@/lib/certTypes';

export const metadata: Metadata = {
  title: 'Pricing & Certification Plans | Jnachi',
  description: 'Transparent pricing for Jnachi AI assessments and professional certifications. 100% free during the 30-day launch window.',
};
          ...
          <div className="bg-gradient-to-b from-indigo-900 via-indigo-900 to-slate-900 text-white p-8 rounded-3xl border-2 border-amber-400 shadow-xl flex flex-col justify-between space-y-6 relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-sm text-slate-400 line-through font-bold">$49 / Exam</span>
              </div>
