...
function ResultContent() {
  ...
  const shareText = encodeURIComponent(`I just scored an ${overallScore} (${overallLevel}) on my Jnachi reading! Check your AI momentum at Jnachi.`);
    ...
    <div className="flex flex-col items-center w-full py-12 px-4 bg-slate-50 min-h-[calc(100vh-16rem)]">
      <div className="max-w-5xl w-full">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Your Current Reading</h1>
